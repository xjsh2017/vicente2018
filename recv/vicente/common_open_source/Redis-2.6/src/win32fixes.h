...
#define _UNI_INT64_
#ifdef OS_WINDOWS
typedef __int64 UNI_INT64; /* vc6 not support long long */
typedef unsigned __int64 UNI_UINT64; /* vc6 not support long long */
#define FMT_lld "%I64d"
#define FMT_llu "%I64u"
#else
typedef long long UNI_INT64; 
typedef unsigned long long UNI_UINT64; 
#define FMT_lld "%lld"
#define FMT_llu "%llu"
#endif
#endif
...
typedef BOOL (__stdcall *_SETFILEPOINTEREX)( HANDLE hFile, LARGE_INTEGER liDistanceToMove, PLARGE_INTEGER lpNewFilePointer, DWORD dwMoveMethod); 
extern _SETFILEPOINTEREX SetFilePointerEx;

#endif
#endif
int replace_ftruncate(int fd, UNI_INT64 length);
