...
class CXJEvent : public CXJNotify
{
public:	
	
	//##ModelId=49B87B9A02DE
	CXJEvent(CDataEngine* pDataEngine);
...
public:
	...
	CXJEventAlarm(CDataEngine* pDataEngine);
...
public:
	...
	CXJEventAction(CDataEngine* pDataEngine);
...
public:
	...
	CXJEventDI(CDataEngine* pDataEngine);
...
public:
	...
	CXJEventOSC(CDataEngine* pDataEngine);
...
public:
	...
	CXJEventPTComm(CDataEngine* pDataEngine);
...
public:
	...
	CXJEventPTRun(CDataEngine* pDataEngine);
...
public:
	...
	CXJEventSysAlarm(CDataEngine* pDataEngine);
...
public:
	...
	CXJEventComm(CDataEngine* pDataEngine);
