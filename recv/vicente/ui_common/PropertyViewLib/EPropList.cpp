...
/*************************************************************
 ...
 参    数: param1 ItemData值
		   Param2 
**************************************************************/
EProperty* EPropList::ETabGroup::FindByItemData( DWORD dData )
{
	std::vector<EProperty*>::iterator it = m_vProperties.begin();
	for(; it != m_vProperties.end(); it++)
	{
		EProperty* temp = (EProperty*)*it;
		if(temp == NULL)
			continue;
 		//比较
 		if(temp->GetItemData() == dData)
 			return temp;
	}
	return NULL;
}
...
/*************************************************************
 ...
 参    数: param1 ItemData值
		   Param2 
**************************************************************/
EProperty* EPropList::FindByItemData( DWORD dData )
{
	return GetTab(m_nCurrentTab)->FindByItemData(dData);
}