...
// Construction
public:
	//##ModelId=49B87BAA0233
	CCJMDIFrameWnd();

// Attributes
public:
protected:
	//##ModelId=49B87BAA0234
	int m_aInitialSize[4];
	//##ModelId=49B87BAA0235
	static DWORD dwDockBarMap[4][2];

// Operations
public:
	//##ModelId=49B87BAA0236
	void SetInitialSize(int top, int bottom, int left, int right);
	//##ModelId=49B87BAA0243
	void RecalcAllExcept(CCJSizeDockBar *pBar);
	//##ModelId=49B87BAA0245
	void EnableDocking(DWORD dwDockStyle);
	//##ModelId=49B87BAA0247
	void EnableDockingSizeBar(DWORD dwDockStyle);
	//##ModelId=49B87BAA0249
	void DockSizeBar(CControlBar *,CCJSizeDockBar* pDock=NULL,LPRECT  pRC= NULL);
	//##ModelId=49B87BAA024D
...
// Overrides
	...
	public:
	//##ModelId=49B87BAA0252
	virtual void RecalcLayout(BOOL bNotify = TRUE);
	//}}AFX_VIRTUAL

// Implementation
public:
	//##ModelId=49B87BAA0255
