 ...
 */
	...
	BOOL BuildDataFor20138StationAdd(STTP_FULL_DATA& sttpData, CString strStationName, CString strSepName);

	BOOL BuildDataFor20138SecConfigChange(STTP_FULL_DATA& sttpData, CString strStationName, CString strDevID, BOOL bAdd = FALSE);
	...
	BOOL BuildDataFor20178StationInit(STTP_FULL_DATA& sttpData, CString sStationID, int nInitFlag, int nStatus);
