	...
	*/
	...
	case XJ_TAGOUT_PTZONESET:
		flow 
			...
			<< XJ_TAGOUT_PTZONESET << "," << XJ_OPER_PTZONESET_STATE_3 << ",0," << XJ_USERGROUP_MONITOR << "," << XJ_FUNC_XJBROWSER_CUSTODY << ",;"
	...
	case XJ_TAGOUT_PTSOFTSET:
		flow 
			...
			<< XJ_TAGOUT_PTSOFTSET << "," << XJ_OPER_PTSOFTSET_STATE_3 << ",0," << XJ_USERGROUP_MONITOR << "," << XJ_FUNC_XJBROWSER_CUSTODY << ",;"
