...
void CSysSettingPageStatus::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_BTN_RUN_HANGOUT_COLOR, m_btnRunHangout);
...
BEGIN_MESSAGE_MAP(CSysSettingPageStatus, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_BTN_RUN_HANGOUT_COLOR, OnBtnRunHangoutColor)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CSysSettingPageStatus::OnBtnRunHangoutColor() 
{
	// TODO: Add your control notification handler code here
	m_btnRunHangout.ShowColorDialog();
}
