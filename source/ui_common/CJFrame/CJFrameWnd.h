...
// Overrides
	...
	public:
	//##ModelId=49B87BAA0282
	virtual void RecalcLayout(BOOL bNotify = TRUE);
	//}}AFX_VIRTUAL

// Implementation
public:
	//##ModelId=49B87BAA0285
	virtual ~CCJFrameWnd();
