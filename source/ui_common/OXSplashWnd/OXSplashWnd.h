...
protected:
	//##ModelId=49B87B960237
	static COXSplashWnd* c_pGlobalWnd;
	//##ModelId=49B87B960242
	static BOOL c_bShowSplashWnd;

	//##ModelId=49B87B960243
	int m_nTimeout;
	//##ModelId=49B87B960244
	BOOL m_bAutoDelete;

	//##ModelId=49B87B960252
	COXSplashWndDIB m_dib;
	//##ModelId=49B87B960257
	CRgn m_rgn;
	//##ModelId=49B87B960261
	COLORREF m_crBorder;
	//##ModelId=49B87B960262
	BYTE m_crBorderR;
	//##ModelId=49B87B960263
	BYTE m_crBorderG;
	//##ModelId=49B87B960271
	BYTE m_crBorderB;
	//##ModelId=49B87B960272
	BYTE m_nTolerance;

	//##ModelId=49B87B960274
	CWnd m_invisParent;

	//##ModelId=49B87B960280
	BOOL m_bUserCancel;

private:
	void PaintWithDetail();
	void PaointNoDetail();
	void DrawPre(CDC *pDC);
	void DrawTransparentBitmap(CDC *pDC, CBitmap *pBitmap, short xStart, short yStart, 
						   COLORREF cTransparentColor);

// Member functions ---------------------------------------------------------
public:
	//##ModelId=49B87B960281
	COXSplashWnd();
	// --- In      :
	// --- Out     : 
	// --- Returns :
	...
	//##ModelId=49B87B96029F
	virtual BOOL LoadBitmap(LPCTSTR lpszResourceName, 
		COLORREF crBorder = CLR_DEFAULT, LPPOINT pStartPoint = NULL, 
		BYTE nTolerance = 0);

	//##ModelId=49B87B9602A5
	virtual BOOL LoadBitmap(UINT nIDResource, COLORREF crBorder = CLR_DEFAULT, 
		LPPOINT pStartPoint = NULL, BYTE nTolerance = 0);
	virtual BOOL LoadBitmapEx(UINT nIDResource, COLORREF crBorder = CLR_DEFAULT, 
		LPPOINT pStartPoint = NULL, BYTE nTolerance = 0, CString sAppName = "", UINT nDIB = 0, CString sDescribe="");
	virtual BOOL LoadBitmapEx(LPCTSTR lpszResourceName, 
		COLORREF crBorder = CLR_DEFAULT, LPPOINT pStartPoint = NULL, 
		BYTE nTolerance = 0, CString sAppName = "", UINT nDIB = 0, CString sDescribe="");
	//##ModelId=49B87B9602B2
