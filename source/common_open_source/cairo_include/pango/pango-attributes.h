...
PangoAttrList *    pango_attr_list_ref           (PangoAttrList  *arg_list);
void               pango_attr_list_unref         (PangoAttrList  *arg_list);
PangoAttrList *    pango_attr_list_copy          (PangoAttrList  *arg_list);
void               pango_attr_list_insert        (PangoAttrList  *arg_list,
						  PangoAttribute *attr);
void               pango_attr_list_insert_before (PangoAttrList  *arg_list,
						  PangoAttribute *attr);
void               pango_attr_list_change        (PangoAttrList  *arg_list,
						  PangoAttribute *attr);
void               pango_attr_list_splice        (PangoAttrList  *arg_list,
						  PangoAttrList  *other,
						  gint            pos,
						  gint            len);

PangoAttrList *pango_attr_list_filter (PangoAttrList       *arg_list,
				       PangoAttrFilterFunc  func,
				       gpointer             data);

PangoAttrIterator *pango_attr_list_get_iterator  (PangoAttrList  *arg_list);

void               pango_attr_iterator_range    (PangoAttrIterator     *arg_iterator,
						 gint                  *start,
						 gint                  *end);
gboolean           pango_attr_iterator_next     (PangoAttrIterator     *arg_iterator);
PangoAttrIterator *pango_attr_iterator_copy     (PangoAttrIterator     *arg_iterator);
void               pango_attr_iterator_destroy  (PangoAttrIterator     *arg_iterator);
PangoAttribute *   pango_attr_iterator_get      (PangoAttrIterator     *arg_iterator,
						 PangoAttrType          type);
void               pango_attr_iterator_get_font (PangoAttrIterator     *arg_iterator,
						 PangoFontDescription  *desc,
						 PangoLanguage        **language,
						 GSList               **extra_attrs);
GSList *          pango_attr_iterator_get_attrs (PangoAttrIterator     *arg_iterator);
